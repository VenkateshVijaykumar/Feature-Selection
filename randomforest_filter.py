"""Authored by: Venkatesh Vijaykumar github: @VenkateshVijaykumar
   This implements Random Forests as a Feature Selection Method.
   The tree method used is the ensemble Random Forests method from sklearn.
   The rf_filter_method acts as a feature 'filter' which performs feature selection based
...
"""
"""To run:
   import the rf_filter_method from this randomforest_filter.py file into your own file.
...
def rf_filter_method(features,classes,percent_reduction=0.5,n_est=10):
    clf = RandomForestClassifier(n_estimators = n_est, criterion = "gini", random_state = 100, max_depth=None, min_samples_leaf=5)
...
if __name__ == '__main__':
    ...
    new_train_feat, sorted_features = rf_filter_method(train_feat,train_class)
